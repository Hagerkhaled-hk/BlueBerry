...
/*  import ff from "../../assets/images/svg/ff.svg" 
 */ 
...
{    highlight:["healthy"],
    ...
    return (
<Swiper className="P1Home mySwiper" 
 pagination={{
    dynamicBullets: true
...
slideData.map((item,index)=>
    {
return (
<SwiperSlide  className={`main-card  card${index}_ `} id="swiper-slide" key={index}>


    <div className="left">
        <img src={shape} alt=""  className="shape"/>
   <small>Flat 30% Off</small>
<h1>  Explore <span>{item.highlight}</span> <br/> {item.category}</h1>
<button>Shop now</button>
    </div>
    <div className="right">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" className=" background" >
        <defs>
...
</svg>        <img src={item.image} className="image"  alt=""/>
    </div>
</SwiperSlide>
)
    } 
